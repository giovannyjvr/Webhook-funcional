...
/* package webhook-0.1.0.0 */
#ifndef VERSION_webhook
#define VERSION_webhook "0.1.0.0"
#endif /* VERSION_webhook */
#ifndef MIN_VERSION_webhook
#define MIN_VERSION_webhook(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_webhook */
...
#define CURRENT_COMPONENT_ID "webhook-0.1.0.0-inplace-webhook"
